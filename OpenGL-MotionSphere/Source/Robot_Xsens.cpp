...
void writeData()
{
	...
	cout	<<"Bone-1: "<<avatarData[0].b1.mData[3]	<< ","	<<	avatarData[0].b1.mData[0]	<< ","	<<	avatarData[0].b1.mData[1]	<< ","	<<	avatarData[0].b1.mData[2]	<<"->"<<	avatarData[trajCount-1].b1.mData[3]	<< ","	<<	avatarData[trajCount-1].b1.mData[0]	<< ","	<<	avatarData[trajCount-1].b1.mData[1]	<< ","	<<	avatarData[trajCount-1].b1.mData[2] 
			<<"Bone-2: "<<avatarData[0].b2.mData[3]	<< ","	<<	avatarData[0].b2.mData[0]	<< ","	<<	avatarData[0].b2.mData[1]	<< ","	<<	avatarData[0].b2.mData[2]	<<"->"<<	avatarData[trajCount-1].b2.mData[3]	<< ","	<<	avatarData[trajCount-1].b2.mData[0]	<< ","	<<	avatarData[trajCount-1].b2.mData[1]	<< ","	<<	avatarData[trajCount-1].b2.mData[2]
			<<"Bone-3: "<<avatarData[0].b3.mData[3]	<< ","	<<	avatarData[0].b3.mData[0]	<< ","	<<	avatarData[0].b3.mData[1]	<< ","	<<	avatarData[0].b3.mData[2]	<<"->"<<	avatarData[trajCount-1].b3.mData[3]	<< ","	<<	avatarData[trajCount-1].b3.mData[0]	<< ","	<<	avatarData[trajCount-1].b3.mData[1]	<< ","	<<	avatarData[trajCount-1].b3.mData[2]
			<<"Bone-4: "<<avatarData[0].b4.mData[3]	<< ","	<<	avatarData[0].b4.mData[0]	<< ","	<<	avatarData[0].b4.mData[1]	<< ","	<<	avatarData[0].b4.mData[2]	<<"->"<<	avatarData[trajCount-1].b4.mData[3]	<< ","	<<	avatarData[trajCount-1].b4.mData[0]	<< ","	<<	avatarData[trajCount-1].b4.mData[1]	<< ","	<<	avatarData[trajCount-1].b4.mData[2]
			<<"Bone-5: "<<avatarData[0].b5.mData[3]	<< ","	<<	avatarData[0].b5.mData[0]	<< ","	<<	avatarData[0].b5.mData[1]	<< ","	<<	avatarData[0].b5.mData[2]	<<"->"<<	avatarData[trajCount-1].b5.mData[3]	<< ","	<<	avatarData[trajCount-1].b5.mData[0]	<< ","	<<	avatarData[trajCount-1].b5.mData[1]	<< ","	<<	avatarData[trajCount-1].b5.mData[2]
			<<"Bone-6: "<<avatarData[0].b6.mData[3]	<< ","	<<	avatarData[0].b6.mData[0]	<< ","	<<	avatarData[0].b6.mData[1]	<< ","	<<	avatarData[0].b6.mData[2]	<<"->"<<	avatarData[trajCount-1].b6.mData[3]	<< ","	<<	avatarData[trajCount-1].b6.mData[0]	<< ","	<<	avatarData[trajCount-1].b6.mData[1]	<< ","	<<	avatarData[trajCount-1].b6.mData[2]
			<<"Bone-7: "<<avatarData[0].b7.mData[3]	<< ","	<<	avatarData[0].b7.mData[0]	<< ","	<<	avatarData[0].b7.mData[1]	<< ","	<<	avatarData[0].b7.mData[2]	<<"->"<<	avatarData[trajCount-1].b7.mData[3]	<< ","	<<	avatarData[trajCount-1].b7.mData[0]	<< ","	<<	avatarData[trajCount-1].b7.mData[1]	<< ","	<<	avatarData[trajCount-1].b7.mData[2]
			<<"Bone-8: "<<avatarData[0].b8.mData[3]	<< ","	<<	avatarData[0].b8.mData[0]	<< ","	<<	avatarData[0].b8.mData[1]	<< ","	<<	avatarData[0].b8.mData[2]	<<"->"<<	avatarData[trajCount-1].b8.mData[3]	<< ","	<<	avatarData[trajCount-1].b8.mData[0]	<< ","	<<	avatarData[trajCount-1].b8.mData[1]	<< ","	<<	avatarData[trajCount-1].b8.mData[2]
			<<"Bone-9: "<<avatarData[0].b9.mData[3]	<< ","	<<	avatarData[0].b9.mData[0]	<< ","	<<	avatarData[0].b9.mData[1]	<< ","	<<	avatarData[0].b9.mData[2]	<<"->"<<	avatarData[trajCount-1].b9.mData[3]	<< ","	<<	avatarData[trajCount-1].b9.mData[0]	<< ","	<<	avatarData[trajCount-1].b9.mData[1]	<< ","	<<	avatarData[trajCount-1].b9.mData[2]	;
*/
